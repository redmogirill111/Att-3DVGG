...
# 对模型进行shift操作的类TemporalShift  首先定义了一个TemporalShift类，该类用来进行shift或者inplace_shift操作。
# net：需要进行shift操作的神经网络，这里默认为resnet
# n_segment：视频分割的段数
# n_div：表示shift操作的比例倒数
