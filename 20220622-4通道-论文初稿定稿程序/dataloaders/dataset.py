...
class VideoDataset(Dataset):
    ...
    def check_preprocess(self):
        ...
        for ii, video_class in enumerate(os.listdir(os.path.join(self.output_dir, 'train'))):
            for video in os.listdir(os.path.join(self.output_dir, 'train', video_class)):
                ...
                if np.shape(image)[0] != self.resize_width or np.shape(image)[1] != self.resize_height:
                    return False
                else:
                    break
    ...
    def process_video(self, video, action_name, save_dir):
        ...
        # # Make sure splited video has at least 16 frames 每4帧抽一帧
        # EXTRACT_FREQUENCY = 4
    ...
    def crop(self, buffer, clip_len, crop_size):
        ...
        # import os
        # number = 0
        # for root, dirs, files in os.walk(r"F:\dataset\rgbandnif111\20220313\2-4\2-4-rgbsdasdafa"):
