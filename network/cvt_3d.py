...
class Generator(nn.Module):
    def __init__(self):
        ...
        self.decoder_layer1_up = VisionTransformer_up(kernel_size=2, stride=2, in_chans=512, embed_dim=256, depth=2,
                                                      num_heads=4)
        # 8*8*8
        ...
        self.decoder_layer2_up = VisionTransformer_up(kernel_size=2, stride=2, in_chans=256, embed_dim=128, depth=1,
                                                      num_heads=4)
        # 16*16*16
        #
