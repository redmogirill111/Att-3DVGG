...
class vgg_3D(nn.Module):
    def __init__(self, num_classes=3):
        ...
        self.conv2_1 = nn.Conv3d(16, 64, kernel_size=(3, 3, 3), stride=1, padding=(1, 1, 1))
        self.conv2_2 = nn.Conv3d(64, 64, kernel_size=(3, 3, 3), stride=1, padding=(1, 1, 1))
        self.pool2 = nn.MaxPool3d(kernel_size=(2, 2, 2), stride=(2, 2, 2))  # 128 * 8 * 8

        self.conv3_1 = nn.Conv3d(64, 128, kernel_size=(3, 3, 3), stride=1, padding=(1, 1, 1))
        self.conv3_2 = nn.Conv3d(128, 128, kernel_size=(3, 3, 3), stride=1, padding=(1, 1, 1))
        ...
        self.conv4_1 = nn.Conv3d(128, 128, kernel_size=(3, 3, 3), stride=1, padding=(1, 1, 1))
        self.conv4_2 = nn.Conv3d(128, 256, kernel_size=(3, 3, 3), stride=1, padding=(1, 1, 1))
        ...
        self.conv5_2 = nn.Conv3d(256, 512, kernel_size=(3, 3, 3), stride=1, padding=(1, 1, 1))
        self.conv6 = nn.Conv3d(512, 64, kernel_size=(1, 1, 1), stride=1)

        self.pool5 = nn.MaxPool3d(kernel_size=(2, 2, 2), stride=(2, 2, 2))

        self.fc6 = nn.Linear(3136, 512)
    ...
    def forward(self, x):
        ...
        conv5_2 = self.relu(self.conv6(conv5_2))
